...
import { initializeDatabase } from "./db/mariadb";
import expenses from "./routes/expenses.mariadb";
import categories from "./routes/categories.mariadb";
import users from "./routes/users.mariadb";
